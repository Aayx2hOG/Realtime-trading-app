declare global {
    ...
    type CountryProps = {
        country?: string;
        region?: string;
        onCountryChangeAction?: (country: string) => void;
        onRegionChangeAction?: (region: string) => void;
        countryId?: string;
        regionId?: string;
        className?: string;
        priorityOptions?: string[];
...
declare module "react-country-region-selector" {
    ...
    class CountryDropdown extends React.Component<CountryDropdownProps, any> { }
    class RegionDropdown extends React.Component<RegionDropdownProps, any> { }
